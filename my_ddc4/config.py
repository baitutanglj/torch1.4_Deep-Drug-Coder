...
model_arg.add_argument('--encoder_hidden_size', type=int, default=512,
                       help='Size of hidden state for '
                            'lstm layers in encoder')
model_arg.add_argument('--encoder_num_layers', type=int, default=2,
...
model_arg.add_argument('--encoder_dropout', type=float, default=0,
                       help='Dropout probability for lstm '
                            'layers in encoder')
# model_arg.add_argument('--latent_output_size', type=int, default=128,
#                        help='Size of output state for '
#                             'linear layers in latent_states')
model_arg.add_argument('--latent_output_size', type=int, default=512,
                       help='Size of output state for '
                            'linear layers in latent_states')
model_arg.add_argument('--latent_num_layers', type=int, default=2,
                       help='Number of linear layers in latent_states')
model_arg.add_argument('--bn', type=bool, default=True,
                       help='BatchNorm1d for latent_states ')
model_arg.add_argument('--bn_momentum', type=float, default=0.9,
                       help='bn_momentum for BatchNorm1d ')
# model_arg.add_argument('--decoder_hidden_size', type=int, default=256,
...
train_arg.add_argument('--train_epochs', type=int, default=121,
...
train_arg.add_argument('--autoencoder_steps', type=int, default=1,
                       help='autoencoder training step')
train_arg.add_argument('--weight_decay', type=int, default=0,
                       help='weight decay for optimizer')
train_arg.add_argument('--save_frequency', type=int, default=5,
                       help='save_frequency')
train_arg.add_argument('--log_file', type=str, default='log_ddc4/log_file',
                       help='log_file')
train_arg.add_argument('--cuda_idx', type=str, default='cuda:3',
                       help='cuda_idx')
